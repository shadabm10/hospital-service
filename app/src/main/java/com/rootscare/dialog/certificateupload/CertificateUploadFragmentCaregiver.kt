...
class CertificateUploadFragmentCaregiver :
    ...
    interface PassDataCallBack{
        fun onPassData(data:com.rootscare.data.model.api.response.caregiver.profileresponse.QualificationDataItem)
    }
        ...
        with(fragmentLayoutBinding!!) {
            ...
            tvSubmit.setOnClickListener {
                if (checkValidationForRegStepOne()){
                    val model = com.rootscare.data.model.api.response.caregiver.profileresponse.QualificationDataItem()
