package com.rootscare.serviceprovider.ui.caregiver.caregiverappointment.adapter
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemCaregiverMyAppointmentRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        init {
            itemView?.root?.crdview_caregiverappoitment_list?.setOnClickListener(View.OnClickListener {
