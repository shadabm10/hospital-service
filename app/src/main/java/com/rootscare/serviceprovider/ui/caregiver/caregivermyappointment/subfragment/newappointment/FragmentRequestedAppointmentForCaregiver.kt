...
class FragmentRequestedAppointmentForCaregiver: BaseFragment<FragmentDoctorRequestedAppointmentBinding, FragmentRequestedAppointmentForNurseViewModel>(),
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterRequestedAppointmentListForCaregiver(requestedappointmentList,context!!)
        ...
        contactListAdapter?.recyclerViewItemClickWithView= object : OnClickOfDoctorAppointment {
            override fun onItemClick(position: Int) {
                ...
                (activity as NursrsHomeActivity).checkFragmentInBackstackAndOpen(
                    FragmentAppointmentDetailsForAll.newInstance(contactListAdapter?.requestedappointmentList!![position]!!.id!!, "nurse","pending"))
            }
