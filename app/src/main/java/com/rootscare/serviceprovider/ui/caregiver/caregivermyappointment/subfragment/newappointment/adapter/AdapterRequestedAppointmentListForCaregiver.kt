...
class AdapterRequestedAppointmentListForCaregiver (val requestedappointmentList: ArrayList<ResultItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterRequestedAppointmentListForCaregiver.ViewHolder>() {
