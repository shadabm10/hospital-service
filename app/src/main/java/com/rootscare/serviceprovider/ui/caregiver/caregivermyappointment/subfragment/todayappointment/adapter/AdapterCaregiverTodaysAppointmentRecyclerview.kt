...
class AdapterCaregiverTodaysAppointmentRecyclerview (internal var todaysAppointList: ArrayList<ResultItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverTodaysAppointmentRecyclerview.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterCaregiverTodaysAppointmentRecyclerview::class.java.simpleName
    }
