package com.rootscare.serviceprovider.caregiver.caregivermyappointment.subfragment.upcomingappointment.adapter
...
class AdapterCaregiverUpcommingAppointment(val upcomingAppointmentList: ArrayList<ResultItem?>?, internal var context: Context) :
    ...
    companion object {
        val TAG: String = AdapterCaregiverUpcommingAppointment::class.java.simpleName
    }
