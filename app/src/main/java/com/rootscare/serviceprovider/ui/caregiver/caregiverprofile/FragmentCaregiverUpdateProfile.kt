...
class FragmentCaregiverUpdateProfile: BaseFragment<FragmentNursesProfileBinding, FragmentCregiverUpdateProfileViewModel>(),
    ...
    var  initialReviewRatingList: ArrayList<com.rootscare.data.model.api.response.caregiver.profileresponse.ReviewRatingItem?>?=null
    var  finalReviewRatingList: ArrayList<com.rootscare.data.model.api.response.caregiver.profileresponse.ReviewRatingItem?>?=null
    var doctorFirstName=""
    var doctorLastName=""
    var doctorEmail=""
...
//                FragmentNursesEditProfile.newInstance())
    ...
    private fun setUpViewPrescriptionlistingRecyclerview(qualificationDataList: ArrayList<com.rootscare.data.model.api.response.caregiver.profileresponse.QualificationDataItem>?) {
        ...
        val contactListAdapter = AdapterCaregiverImportantDocumentrecyclerview(qualificationDataList,activity!!)
    ...
    // Set up recycler view for service listing if available
    private fun setReviewRatingListing(reviewRatingList: ArrayList<com.rootscare.data.model.api.response.caregiver.profileresponse.ReviewRatingItem?>?) {
        ...
        recyclerView.isNestedScrollingEnabled = false
        recyclerView.setHasFixedSize(false)
        val contactListAdapter = AdapterCaregiverdetailsReviewListRecyclerview(reviewRatingList,context!!)
        recyclerView.adapter = contactListAdapter
    }
    ...
    override fun successGetDoctorProfileResponse(getDoctorProfileResponse: com.rootscare.data.model.api.response.caregiver.profileresponse.GetDoctorProfileResponse?) {
        ...
        if (getDoctorProfileResponse?.code.equals("200")){
            if(getDoctorProfileResponse?.result!=null){
                ...
                if(getDoctorProfileResponse?.result?.department!=null && getDoctorProfileResponse?.result?.department.equals("")){
                ...
                initialReviewRatingList= ArrayList<com.rootscare.data.model.api.response.caregiver.profileresponse.ReviewRatingItem?>()
                finalReviewRatingList= ArrayList<com.rootscare.data.model.api.response.caregiver.profileresponse.ReviewRatingItem?>()
                ...
                if(getDoctorProfileResponse?.result?.reviewRating!=null && getDoctorProfileResponse?.result?.reviewRating.size>0){
                    ...
                    if(getDoctorProfileResponse?.result?.reviewRating?.size>1){
                        ...
                        var reviewRatingItem=com.rootscare.data.model.api.response.caregiver.profileresponse.ReviewRatingItem()
