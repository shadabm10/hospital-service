...
class AdapterCaregiverFeesListRecyclerview   ( internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverFeesListRecyclerview.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterCaregiverFeesListRecyclerview::class.java.simpleName
    }
