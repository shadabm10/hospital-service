...
class AdapterCaregiverImportantDocumentrecyclerview   (val qualificationDataList: ArrayList<com.rootscare.data.model.api.response.caregiver.profileresponse.QualificationDataItem>?, internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverImportantDocumentrecyclerview.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterCaregiverImportantDocumentrecyclerview::class.java.simpleName
    }
