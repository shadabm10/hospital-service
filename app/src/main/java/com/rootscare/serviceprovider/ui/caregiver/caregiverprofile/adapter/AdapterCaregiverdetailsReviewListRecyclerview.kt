...
class AdapterCaregiverdetailsReviewListRecyclerview (val reviewRatingList: ArrayList<com.rootscare.data.model.api.response.caregiver.profileresponse.ReviewRatingItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverdetailsReviewListRecyclerview.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
//    val reviewRatingList: ArrayList<ReviewRatingItem?>?,
    companion object {
        val TAG: String = AdapterCaregiverdetailsReviewListRecyclerview::class.java.simpleName
    }
