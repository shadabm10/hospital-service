...
class FragmentCaregiverUpdateReviewAndRating: BaseFragment<FragmentNursesReviewAndRatingBinding, FragmentCaregiverUpdateReviewAndRatingViewModel>(),
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterCaregiverUpdateReviewAndRating(context!!)
