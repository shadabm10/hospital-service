...
class AddapterDoctorMyAppointmentListRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AddapterDoctorMyAppointmentListRecyclerview.ViewHolder>() {
