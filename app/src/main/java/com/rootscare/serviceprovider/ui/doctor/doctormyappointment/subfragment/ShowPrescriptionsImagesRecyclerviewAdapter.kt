...
import com.rootscare.data.model.api.response.doctor.appointment.appointmentdetails.Prescription
        ...
        fun onBind(pos: Int) {
            ...
            with(itemVie) {
                ...
                if (todaysAppointList!![local_position].e_prescription != null && !TextUtils.isEmpty(todaysAppointList!![local_position].e_prescription?.trim())) {
                    ...
                    Glide
                        .with(context)
                        .load(context.getString(R.string.api_base) + "uploads/images/" + todaysAppointList!![local_position].e_prescription)
                        .apply(options)
