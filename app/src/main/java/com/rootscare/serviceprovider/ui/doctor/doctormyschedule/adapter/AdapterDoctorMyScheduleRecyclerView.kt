...
class AdapterDoctorMyScheduleRecyclerView  ( internal var context: Context) : RecyclerView.Adapter<AdapterDoctorMyScheduleRecyclerView.ViewHolder>() {
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemDoctorMyScheduleRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        init {
            itemView?.root?.txt_view_schedule?.setOnClickListener(View.OnClickListener {
