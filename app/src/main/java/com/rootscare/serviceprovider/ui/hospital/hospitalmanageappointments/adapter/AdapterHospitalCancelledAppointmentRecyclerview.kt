...
class AdapterHospitalCancelledAppointmentRecyclerview  ( internal var context: Context) : RecyclerView.Adapter<AdapterHospitalCancelledAppointmentRecyclerview.ViewHolder>() {
