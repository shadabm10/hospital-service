...
class AdapterHospitalPastAppointmentRecyclerview  ( internal var context: Context) : RecyclerView.Adapter<AdapterHospitalPastAppointmentRecyclerview.ViewHolder>() {
