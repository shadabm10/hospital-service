...
class AdapterHospitalUpcomingAppointmentRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterHospitalUpcomingAppointmentRecyclerview.ViewHolder>() {
