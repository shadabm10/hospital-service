...
import com.rootscare.serviceprovider.databinding.ItemHospitalManageNotificationRecyclerviewBinding
import com.rootscare.serviceprovider.ui.hospital.hospitalmanagedoctor.adapter.AdapterHospitalManageDoctorRecyclerview

class AdapterHospitalManageNotificationRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterHospitalManageNotificationRecyclerview.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemHospitalManageNotificationRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_hospital_manage_notification_recyclerview, parent, false)
