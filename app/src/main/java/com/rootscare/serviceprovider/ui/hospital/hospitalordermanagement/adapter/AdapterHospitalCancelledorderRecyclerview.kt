...
class AdapterHospitalCancelledorderRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterHospitalCancelledorderRecyclerview.ViewHolder>() {
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemHospitalCancelledOrderRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        init {
            itemView?.root?.crdview_hospitalcancelledorder_list?.setOnClickListener(View.OnClickListener {
