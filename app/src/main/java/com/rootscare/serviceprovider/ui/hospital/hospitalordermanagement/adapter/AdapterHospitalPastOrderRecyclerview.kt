...
class AdapterHospitalPastOrderRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterHospitalPastOrderRecyclerview.ViewHolder>() {
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemHospitalPastOrderRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        init {
            itemView?.root?.crdview_hospitalorder_list?.setOnClickListener(View.OnClickListener {
