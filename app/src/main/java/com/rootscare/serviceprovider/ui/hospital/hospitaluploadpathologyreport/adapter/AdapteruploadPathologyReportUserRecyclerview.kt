...
class AdapteruploadPathologyReportUserRecyclerview  ( internal var context: Context) : RecyclerView.Adapter<AdapteruploadPathologyReportUserRecyclerview.ViewHolder>() {
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemHospitalUploadPathologyTestUserRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        init {
            itemView?.root?.card_view_upload_pathology_user_list?.setOnClickListener(View.OnClickListener {
