...
class FragmentLabTechnicianMySpeciality: BaseFragment<FragmentLabtechnicianMySpecialityBinding, FragmentLabTechnicianMySpecialityViewModel>(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentLabtechnicianMySpecialityBinding?.txtAddSpeciality?.setOnClickListener(View.OnClickListener {
            CommonDialog.showDialogForAddLabtechnicianSpeciality(context!!,object:
            DialogClickCallback {
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        val contactListAdapter = AdapterLabTechnicianMySpecilitiesList(context!!)
